...
<table>
	...
	<tr>
		<td>Tujuan Wisata</td>
		<td>
		<input type="checkbox" name="ws[]" value="Bali" <?php if(in_array('Bali',$array2)){echo "checked=checked";} ?> >Bali <br>
		<input type="checkbox" name="ws[]" value="Raja Ampat" <?php if(in_array('Raja ampat',$array2)){echo "checked=checked";} ?> >Raja Ampat <br>
		<input type="checkbox" name="ws[]" value="Pulau Derawan" <?php if(in_array('Pulau Derawan',$array2)){echo "checked=checked";} ?> >Pulau Derawan <br>
		<input type="checkbox" name="ws[]" value="Bangka Belitung" <?php if(in_array('Bangka belitung',$array2)){echo "checked=checked";} ?> >Bangka Belitung <br>
		<input type="checkbox" name="ws[]" value="Labuan Bajo" <?php if(in_array('Labuan bajo',$array2)){echo "checked=checked";} ?> >Labuan Bajo <br>
		</td>
	</tr>
	<tr>
		<td></td>
